...
@section('content')
    <div class="container mt-5 mb-5">
        <div class="row">
            ...
            <p>¡Bienvenido a Grupo Palermo!
                Estos términos y condiciones describen las reglas y regulaciones para el uso del sitio web de Grupo Palermo, ubicado en https://www.grupopalermo.pe/.
                Al acceder a este sitio web, asumimos que aceptas estos términos y condiciones. No continúes usando Grupo Palermo si no estás de acuerdo con todos los términos y condiciones establecidos en esta página.
            </p>
        </div>
        <div class="row">
            <h2>Cookies:</h2>
            <p>El sitio web utiliza cookies para ayudar a personalizar tu experiencia en línea. Al acceder a Grupo Palermo, aceptaste utilizar las cookies necesarias.
        ...
        <div class="row">
            <h2>Licencia:</h2>
            <p>A menos que se indique lo contrario, Grupo Palermo y/o sus licenciantes poseen los derechos de propiedad intelectual de todo el material en Grupo Palermo. Todos los derechos de propiedad intelectual son reservados. Puedes acceder desde Grupo Palermo para tu uso personal sujeto a las restricciones establecidas en estos términos y condiciones.</p>
            <p>No debes:</p>
            <ul>
                <li>Copiar o volver a publicar material de Grupo Palermo</li>
                <li>Vender, alquilar o sublicenciar material de Grupo Palermo</li>
                <li>Reproducir, duplicar o copiar material de Grupo Palermo</li>
                <li>Redistribuir contenido de Grupo Palermo</li>
            </ul>
            <p>Este acuerdo comenzará el fecha presente.
                Partes de este sitio web ofrecen a los usuarios la oportunidad de publicar e intercambiar opiniones e información en determinadas áreas. Grupo Palermo no filtra, edita, publica ni revisa los comentarios antes de su presencia en el sitio web. Los comentarios no reflejan los puntos de vista ni las opiniones de Grupo Palermo, sus agentes y/o afiliados. Los comentarios reflejan los puntos de vista y opiniones de la persona que publica. En la medida en que lo permitan las leyes aplicables, Grupo Palermo no será responsable de los comentarios ni de ninguna responsabilidad, daños o gastos causados ​​o sufridos como resultado de cualquier uso o publicación o apariencia de comentarios en este sitio web.
                Grupo Palermo se reserva el derecho de monitorear todos los comentarios y eliminar los que puedan considerarse inapropiados, ofensivos o que incumplan estos Términos y Condiciones.
            </p>
            ...
            <p>Por la presente, otorgas a Grupo Palermo una licencia no exclusiva para usar, reproducir, editar y autorizar a otros a usar, reproducir y editar cualquiera de tus comentarios en todas y cada una de las formas, formatos, o medios.</p>
        </div>
        <div class="row">
            ...
            <ul>
                <li>fuentes de información de consumidores y/o empresas comúnmente conocidas;
                </li>
                <li>sitios de la comunidad .com;</li>
                <li>asociaciones u otros grupos que representan organizaciones benéficas;
                </li>
            ...
            <p>Aprobaremos las solicitudes de enlace de estas organizaciones si: (a) el enlace no nos haría vernos desfavorablemente a nosotros mismos ni a nuestras empresas acreditadas; (b) la organización no tiene registros negativos con nosotros; (c) el beneficio para nosotros de la visibilidad del hipervínculo compensa la ausencia de Grupo Palermo; y (d) el enlace está en el contexto de información general de recursos.
                ...
                Si eres una de las organizaciones enumeradas en el párrafo 2 y estás interesada en vincularte a nuestro sitio web, debes informarnos enviando un correo electrónico a Grupo Palermo. Incluye tu nombre, el nombre de tu organización, la información de contacto, así como la URL de tu sitio, una lista de las URL desde las que tienes la intención de vincular a nuestro sitio web y una lista de las URL de nuestro sitio a las que te gustaría acceder. Espera 2-3 semanas para recibir una respuesta.
            ...
            <p>No se permitirá el uso del logotipo de Grupo Palermo u otro material gráfico para vincular sin un acuerdo de licencia de marca comercial.</p>
        ...
        <div class="row">
            ...
            <p>En la medida máxima permitida por la ley aplicable, excluimos todas las representaciones, garantías y condiciones relacionadas con nuestro sitio web y el uso de este. Nada en este descargo de responsabilidad:
            </p>
            <ul>
                <li>limitará o excluirá nuestra responsabilidad o la tuya por muerte o lesiones personales;</li>
                <li>limitará o excluirá nuestra responsabilidad o la tuya por fraude o tergiversación fraudulenta;
                </li>
...
@endsection
@push('css')
    <link rel="stylesheet" href="{{ asset('frontend/css/legales.css') }}">
@endpush
