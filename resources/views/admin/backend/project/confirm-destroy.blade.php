...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li><a href="{!! URL::route('admin.project.index') !!}"><i class="fa fa-gears"></i> Project</a></li>
...
<br>
<br>
<div class="col-lg-10"> {!! Form::open( array(  'route' => array('admin.project.destroy', $project->id ) ) ) !!}
