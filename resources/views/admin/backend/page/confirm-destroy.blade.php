...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li><a href="{!! URL::route('admin.page.index') !!}"><i class="fa fa-bookmark"></i> Dashboard</a></li>
...
<div class="col-lg-10">
    ...
    {!! Form::hidden('_method', 'DELETE') !!}
     <div class="alert alert-danger">
            There might be a link given to this page, <a href="{!! URL::route('admin.menu.index') !!}">Check it</a>
        </div>
